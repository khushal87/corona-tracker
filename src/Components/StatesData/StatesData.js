                        ...
                        return <div className="country-data" key={key}>
                            <div className="country-name">{indiData.state + " "}
                                <div style={{ display: 'flex', flexDirection: "row", justifyContent: "space-around" }}>
                                    <div className="country-deaths" style={{ color: "red", width: "180px" }}>Cases : {indiData.confirmed + (indiData.deltaconfirmed !== 0 ? ` (+${indiData.deltaconfirmed})` : "")}</div>
                                    <div className="country-deaths" style={{ color: "green", width: "150px" }}>Cured : {indiData.recovered + (indiData.deltarecovered !== 0 ? ` (+${indiData.deltarecovered})` : "")}</div>
                                    <div className="country-deaths" style={{ color: "#282c84", width: "170px" }}>Deaths : {indiData.deaths + (indiData.deltadeaths !== 0 ? ` (+${indiData.deltadeaths})` : "")}</div>
                                </div>
                            </div>
                        </div>
                    })
