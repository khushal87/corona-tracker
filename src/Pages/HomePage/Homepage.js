            ...
            <div className="homepage">
                ...
                <header className="App-header">
                    ...
                    <div style={{ paddingTop: "5px", marginLeft: "5px", marginRight: "5px" }}>
                        <Blink color='#d9534f ' text='As the Lockdown has been extended kindly follow the guidelines. We wish you happy health :)' fontSize='18'>
                            As the Lockdown has been extended kindly follow the guidelines. We wish you happy health :)
                            </Blink>
